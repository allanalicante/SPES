                                                    ...
                                                    ?>
                                                            <tr>
                                                              ...
                                                              <button type="button" class="badge btn btn-success editLevel" data-bs-toggle="modal" 
                                                               data-bs-target="#editmodallevel" data-bs-whatever="@getbootstrap">Edit</button>                                 
                                                              </td>                    
                                                            </tr>
                                                            <?php } ?>
      ...
      <div class="modal-body">
        ...
        <form action="MyCrud.php" method="POST" >
            ...
            <div class="mb-3">
                ...
                <input type="text" name="section" class="form-control" id="section" required></textarea>
            </div>

          <!--   <div class="mb-3">
              <label for="advisory" class="col-form-label">Advisory</label>            
              <select class="form-control" name="advisory" id="advisory">
              <option value="" disabled selected>Select</option> 
              <?php 
              $connection = mysqli_connect("localhost","root","");
              $db = mysqli_select_db($connection,'spes_db');
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h5 style="color:white" class="modal-title" id="exampleModalLabel1">EDIT LEVEL AND SECTION</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      ...
      <form action="MyCrud.php" method="POST" >
          ...
          <div class="mb-3">
            <label for="section" class="col-form-label">Section</label>
            <input type="text" class="form-control" name="editsection" id="editsection" required></textarea>
          </div>
